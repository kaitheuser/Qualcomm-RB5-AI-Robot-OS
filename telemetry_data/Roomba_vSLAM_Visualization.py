...
with open("/Users/kaitheuser/Downloads/Qualcomm-RB5-AI-Robot-roomba_OS/waypoints/coverage_waypoints.csv", 'r') as f:
    csvreader = csv.reader(f)
...
ani = FuncAnimation(fig=fig, func=update, interval = 220)
plt.show()
